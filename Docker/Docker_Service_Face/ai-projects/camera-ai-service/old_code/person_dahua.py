...
from app.common.Enum.type_camera import TypeCameraEnum
...
from app.services.person_camera.person_camera import IPersonCamera
...
class PersonDahua(IPersonCamera):
    def update_image(
        self,
