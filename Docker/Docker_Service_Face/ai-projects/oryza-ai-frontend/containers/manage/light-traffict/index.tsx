...
import headData from "@/data/manage/light-traffict";
import { EventData } from "@/interfaces/manage/event";
import { AnimatePresence } from "framer-motion";
import TableLightTraffictItem from "./table";
import clsx from "clsx";
import { useManagement } from "@/context/manage-context";

export interface ILightTraffictProps {
  loading: boolean;
  data: EventData[];
  page: any;
}

export function LightTraffict(props: ILightTraffictProps) {
