        ...
        >
          ...
          >
            <div className="flex flex-row space-x-1 items-center">
              <p className="truncate">{data.license_plate}</p>
              <CopyBtn text={data?.license_plate} title="biển số" />
            </div>
            <div>
              <p className="flex-1 truncate text-[14px]">
                <span>Loại xe:</span> {data.vehicle_type}
              </p>
              <p className="flex-1 truncate text-[11px]">
                {data.timestamp
        ...
        <div className="flex justify-between items-center">
          <div className="flex gap-2 items-center w-full">
            ...
            <div className="truncate">
              <p className="text-[12px] font-medium capitalize truncate text-grayOz">
                <span>Camera:</span> {data?.camera_name || "--"}
              </p>
              <p className="text-[12px] font-medium capitalize truncate text-grayOz">
                <span>Hãng xe:</span> {data?.brand_name || "--"}
              </p>
              <p className="text-[12px] font-medium capitalize truncate  text-grayOz">
                <span>Màu xe:</span> {data.vehicle_color || "--"}
              </p>
            </div>
          </div>
        </div>
