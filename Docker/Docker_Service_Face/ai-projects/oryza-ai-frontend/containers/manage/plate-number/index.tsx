...
import headData from "@/data/manage/plate-number";
import { EventData } from "@/interfaces/manage/event";
import { TablePlateNumberItem } from "./table";
import { AnimatePresence } from "framer-motion";
import { TableAnimation } from "@/components";
import clsx from "clsx";
import { useManagement } from "@/context/manage-context";

export interface ITablePlaceNumberProps {
  loading: boolean;
  data: any;
  page: any;
}

export function TablePlateNumber(props: ITablePlaceNumberProps) {
