...
import headData from "@/data/manage/lane-violation";
import { EventData } from "@/interfaces/manage/event";
import { TableLaneViolationItem } from "./table";
...
export function TableLaneViolation(props: ITableLaneViolationProps) {
