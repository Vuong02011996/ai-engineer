...
import headData from "@/data/manage/illegal-parking";
import { EventData } from "@/interfaces/manage/event";
import TableIllegalParkingItem from "./table";
import { AnimatePresence } from "framer-motion";
import { TableAnimation } from "@/components";
import { useManagement } from "@/context/manage-context";
import clsx from "clsx";

export interface ITableIllegalParkingProps {
  loading: boolean;
  data: any;
  page: any;
}

export function TableIllegalParking(props: ITableIllegalParkingProps) {
