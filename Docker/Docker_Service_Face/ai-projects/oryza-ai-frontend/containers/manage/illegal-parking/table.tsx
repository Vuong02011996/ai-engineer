...
export interface ITableIllegalParkingItemProps {
  data: EventData;
  index: number;
}

function TableIllegalParkingItem(props: ITableIllegalParkingItemProps) {
...
export default memo(TableIllegalParkingItem);
