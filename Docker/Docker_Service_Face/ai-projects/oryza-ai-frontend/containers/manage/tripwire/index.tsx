...
import headData from "@/data/manage/tripwire";
import { EventData } from "@/interfaces/manage/event";
import TableTripwireItem from "./table";
import { AnimatePresence } from "framer-motion";
import { TableAnimation } from "@/components";
import { useManagement } from "@/context/manage-context";
import clsx from "clsx";

export interface ITableTripwireProps {
  loading: boolean;
  data: any;
  page: any;
}

export function TableTripwire(props: ITableTripwireProps) {
