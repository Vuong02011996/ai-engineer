...
export interface IConfigItemsForgottenDialogProps {
  open: boolean;
  handleClose: () => void;
...
export function ConfigItemsForgottenDialog(
  props: IConfigItemsForgottenDialogProps
) {
  // ************** --init state-- *****************
  ...
  //   setLoadingImg(true);
  //   try {
  //     let { data } = await LoiteringDetectionApi.getImageByIdCamera(id);
  //     setimage(data);
