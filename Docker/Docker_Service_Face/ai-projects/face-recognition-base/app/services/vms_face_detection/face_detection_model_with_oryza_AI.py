...
from core.main.export_data_oryza_ai import export_data_all_face_high_confidence
...
def run_roll_call(item_cam, end_time_s, info_cam_running, test_video=False, cv2_show=True, window="test"):
    ...
    thread7 = KThread(target=export_data_all_face_high_confidence, args=(cam, database_queue, object_dal, info_cam_running))
    if cv2_show:
