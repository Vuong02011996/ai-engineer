...
# path_model_head_person = os.getenv("path_model_head_person")
# # model = YOLO('models/model_Manh.pt')
# model = YOLO(path_model_head_person)
# path_model_head_person='/home/oryza/Desktop/Projects/Loiter_Detection/core/models_local/head_detection/yolov8_detection/head_peron_yolov8_v1.pt'
...
def person_detect(image_infer):
    ...
    result = model(image_infer, verbose=False, conf=0.3, iou=0.4)
    bboxes = []
    labels = []
    scores = []
    preds = []
