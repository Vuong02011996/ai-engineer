...
import torch
import numpy as np
from core.models_local.head_detection.yolov5_detect.models.experimental import attempt_load
from core.models_local.head_detection.yolov5_detect.utils.general import check_img_size, non_max_suppression, scale_coords
from core.models_local.head_detection.yolov5_detect.utils.datasets import letterbox
import cv2
